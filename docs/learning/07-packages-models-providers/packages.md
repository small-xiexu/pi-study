...
本文按 Pi `0.84.2` 保存 Package 的稳定知识、实验方法和证据边界。学习状态、Red/Green、失败、纠正和验收历史只见[完整学习计划](../../plans/pi-complete-learning-plan.md)；阶段 6 总览见[Packages、Models 与 Providers](../07-packages-models-providers.md)。
...
- [6.1 Package 来源](../../../labs/6.1-package-sources/README.md)
- [6.2 Package 安全](../../../labs/6.2-package-security/README.md)
- [6.3 源码与归档等价](../../../labs/6.3-local-package/README.md)
- [6.4 Package 管理](../../../labs/6.4-package-management/README.md)

这些 README 保存可重复实验入口和最大证明范围；具体执行时间线与学习者验收仍只记录在唯一计划中。
